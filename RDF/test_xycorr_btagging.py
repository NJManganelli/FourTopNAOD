...
f_mc = "/eos/user/n/nmangane/SWAN_projects/LogicChainRDF/FilesV2/ElMu_selection/tt*.root"
f_data = "/eos/user/n/nmangane/SWAN_projects/LogicChainRDF/FilesV2/ElMu_selection/data*.root"
...
r = ROOT.ROOT.RDataFrame("Events", f_mc)#.Range(10000)
...
hists["MC_phi_corr_btagged"] = rd.Histo1D(("hphi_corr_btag", "MET #phi xy-corrected, deepcsv btag event weight; #phi; Events",
                                   36, -3.14, 3.14), "MET_xycorr_phi", "btagEventWeight")
hists["MC_pt_shift"] = rd.Histo1D(("hpt_shift", "p_T shift after MET xy-correction", 200, -20, 20), "MET_xycorr_pt_shift", "genWeight")
...
hists["Data_phi_corr_btagged"] = hists["Data_phi_corr"]
hists["Data_pt_shift"] = rd.Histo1D(("hdpt_shift", "", 200, -20, 20), "MET_xycorr_pt_shift", "genWeight")
