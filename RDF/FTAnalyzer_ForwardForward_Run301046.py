            ...
            for processName in nodes:
                ...
                for decayChannel in ["ElMu{lpf}".format(lpf=leppostfix), 
                    ...
                    if decayChannel == "ElMu{lpf}".format(lpf=leppostfix):
                        channelFilter = "nFTALepton{lpf} == 2 && nFTAMuon{lpf} == 1 && nFTAElectron{lpf}== 1 && abs(FTALepton{lpf}_eta.at(0)) >= 1.4660 && abs(FTALepton{lpf}_eta.at(1)) >= 1.4660".format(lpf=leppostfix)
                        ...
                        channelFilter = "nFTALepton{lpf} == 2 && nFTAMuon{lpf} == 2 && abs(FTALepton{lpf}_eta.at(0)) >= 1.4660 && abs(FTALepton{lpf}_eta.at(1)) >= 1.4660".format(lpf=leppostfix)
                        ...
                        channelFilter = "nFTALepton{lpf} == 2 && nFTAElectron{lpf}== 2 && abs(FTALepton{lpf}_eta.at(0)) >= 1.4660 && abs(FTALepton{lpf}_eta.at(1)) >= 1.4660".format(lpf=leppostfix)
