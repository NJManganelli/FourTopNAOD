...
namespace FTA{
  ...
  std::map< std::string, std::vector<std::string> > GetCorrectorMap(std::string era, 
	...
	muon_options_syst["LooseID"] =                   {"Mu_ID.root", "MC_NUM_LooseID_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["MediumID2016"] =           {"Mu_ID.root", "MC_NUM_MediumID2016_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["MediumID2016"] =              {"Mu_ID.root", "MC_NUM_MediumID2016_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["MediumID"] =               {"Mu_ID.root", "MC_NUM_MediumID_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["MediumID"] =                  {"Mu_ID.root", "MC_NUM_MediumID_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["TightID"] =                {"Mu_ID.root", "MC_NUM_TightID_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["TightID"] =                   {"Mu_ID.root", "MC_NUM_TightID_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["HighPtID"] =               {"Mu_ID.root", "MC_NUM_HighPtID_DEN_genTracks_PAR_newpt_eta/pair_ne_ratio", "TH2Lookup", };
	muon_options_syst["HighPtID"] =                  {"Mu_ID.root", "MC_NUM_HighPtID_DEN_genTracks_PAR_newpt_eta/pair_ne_ratio", "TH2LookupErr", };

	muon_options_central["LooseRelIso/LooseID"] =    {"Mu_Iso.root", "LooseISO_LooseID_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["LooseRelIso/LooseID"] =       {"Mu_Iso.root", "LooseISO_LooseID_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["LooseRelIso/MediumID"] =   {"Mu_Iso.root", "LooseISO_MediumID_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["LooseRelIso/MediumID"] =      {"Mu_Iso.root", "LooseISO_MediumID_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["LooseRelIso/TightID"] =    {"Mu_Iso.root", "LooseISO_TightID_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["LooseRelIso/TightID"] =       {"Mu_Iso.root", "LooseISO_TightID_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["TightRelIso/MediumID"] =   {"Mu_Iso.root", "TightISO_MediumID_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["TightRelIso/MediumID"] =      {"Mu_Iso.root", "TightISO_MediumID_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["TightRelIso/TightID"] =    {"Mu_Iso.root", "TightISO_TightID_pt_eta/pt_abseta_ratio", "TH2Lookup", };
	muon_options_syst["TightRelIso/TightID"] =       {"Mu_Iso.root", "TightISO_TightID_pt_eta/pt_abseta_ratio", "TH2LookupErr", };
	muon_options_central["LooseRelTkIso/HighPtID"] = {"Mu_Iso.root", "tkLooseISO_highptID_newpt_eta/pair_ne_ratio", "TH2Lookup", };
	muon_options_syst["LooseRelTkIso/HighPtID"] =    {"Mu_Iso.root", "tkLooseISO_highptID_newpt_eta/pair_ne_ratio", "TH2LookupErr", };
      }
      elif(legacy == "UL" && VFP == "preVFP"){
      }
      elif(legacy == "UL" && VFP == "postVFP"){
	...
	//from automated script :) ^^^ vs hand-crafted from years ago, vvv
