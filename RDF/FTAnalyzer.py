...
def main(analysisDir, inputSamples, source, channel, bTagger, systematicsCards, doDiagnostics=False, 
    ...
    sysVariationsYaml, sysVariationCardDict = load_yaml_cards(systematicsCards)
...
if __name__ == '__main__':
    ...
    systematicsCards=args.systematics_cards
    ...
    if stage == 'fill-yields':
        ...
        packed = main(analysisDir, inputSamples, source, channel, bTagger, systematicsCards, doDiagnostics=False, doHistos=False, doBTaggingYields=True, BTaggingYieldsFile="{}", 
        ...
        packed = main(analysisDir, inputSamples, source, channel, bTagger, systematicsCards, doDiagnostics=False, doHistos=False, doLeptonSelection=True, doBTaggingYields=False, 
        ...
        packed = main(analysisDir, inputSamples, source, channel, bTagger, systematicsCards, doDiagnostics=True, doHistos=False, doBTaggingYields=False, BTaggingYieldsFile="{}", 
        ...
        packed = main(analysisDir, inputSamples, source, "BOOKKEEPING", bTagger, systematicsCards, doDiagnostics=False, doHistos=False, doBTaggingYields=False, BTaggingYieldsFile="{}", 
                      BTaggingYieldsAggregate=useAggregate, jetPtMin=jetPtMin, jetPUId=jetPUId, useDeltaR=useDeltaR, useHTOnly=useHTOnly, 
        ...
        packed = main(analysisDir, inputSamples, source, channel, bTagger, systematicsCards, doDiagnostics=False, 
