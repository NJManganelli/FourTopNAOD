...
def multiplier(fileList, hName=None, NLeps=None, theEra="2017", theBTagger=['CSVv2','M'], evtConfig=[True, 1, 1, 1], maxevt=-1): #evtConfig=[isData, genEquivalentLuminosity, genXS, genNEvents]
    if hName == None:
        hDirName = None
    else:
        hName = hName
