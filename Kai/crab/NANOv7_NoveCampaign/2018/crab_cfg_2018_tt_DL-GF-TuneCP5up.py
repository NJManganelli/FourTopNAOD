...
config.General.requestName = '2018_tt_DL-GF-TuneCP5up'
config.General.transferOutputs = True
config.General.transferLogs = True
config.section_("JobType")
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'crab_PSet_2018_tt_DL-GF-TuneCP5up.py'
config.JobType.maxMemoryMB = 3000
config.JobType.maxJobRuntimeMin = 1315
config.JobType.numCores = 1
config.JobType.scriptExe = 'crab_script_2018_tt_DL-GF-TuneCP5up.sh'
config.JobType.inputFiles = ['crab_script_2018_tt_DL-GF-TuneCP5up.py', 
...
config.Data.inputDataset = '/TTTo2L2Nu_HT500Njet7_TuneCP5up_13TeV-powheg-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_102X_upgrade2018_realistic_v21-v1/NANOAODSIM'
