...
# process.options.numberOfThreads = 1 #Not correct way to initialize
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring(),
#	lumisToProcess=cms.untracked.VLuminosityBlockRange("254231:1-254231:24")
)
process.source.fileNames = [
	'/afs/cern.ch/work/n/nmangane/scratch1/CMSSW_10_2_24_patch1/src/PhysicsTools/NanoAODTools/test/lzma.root' ##you can change only this line
]
