...
config.General.requestName = '2017_tttt_badNPartonInBorn'
config.General.transferOutputs = True
config.General.transferLogs = True
config.section_("JobType")
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'crab_PSet_2017_tttt_badNPartonInBorn.py'
config.JobType.maxMemoryMB = 3000
config.JobType.maxJobRuntimeMin = 2750
config.JobType.numCores = 1
config.JobType.scriptExe = 'crab_script_2017_tttt_badNPartonInBorn.sh'
config.JobType.inputFiles = ['crab_script_2017_tttt_badNPartonInBorn.py', 
...
config.Data.inputDataset = '/TTTT_TuneCP5_PSweights_13TeV-amcatnlo-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_102X_mc2017_realistic_v8-v1/NANOAODSIM'
