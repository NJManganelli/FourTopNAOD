...
process.source.fileNames = [
	'/afs/cern.ch/work/n/nmangane/scratch1/testNanoProduction/CMSSW_10_2_24_patch1/src/PhysicsTools/NanoAODTools/test/lzma.root' ##you can change only this line
]
