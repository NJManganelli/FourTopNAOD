...
class JetMETLogic(Module):
    def __init__(self, verbose=False, maxevt=-1, probEvt=None, isData=True, 
                 genEquivalentLuminosity=1, genXS=1, genNEvents=1, genSumWeights=1, era="2017", btagging=['DeepCSV','M'], lepPt=25, MET=50, HT=500, invertZWindow=False, invertZWindowEarlyReturn=True, GenTop_LepSelection=None, jetPtVar = "pt_nom", jetMVar = "mass_nom", fillHists=False):
