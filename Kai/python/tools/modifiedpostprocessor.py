...
class PostProcessor :
	...
	for fname in self.inputFiles:
		...
		(nall, npass, timeLoop) = eventLoop(self.modules, inFile, outFile, inTree, outTree, eventRange=eventRange, 
                                                    maxEvents=self.maxEntries, progress=(self.reportEvery, self.eventLoopOut))
